                            ...
                            @foreach($rules as $rule)
                                <tr class="rules">
                                    ...
                                    <td>
                                        ...
                                        <div class="col-6 form-group">
                                            <button class="btn btn-icon btn-info waves-effect waves-light waves-round" data-target="#exampleTabs{{$rule->id}}" data-toggle="modal"
                                            data-original-title="Editar"><i class="icon md-edit" aria-hidden="true"></i></button>
                                        </div>
                                        <!-- END Botón-->
                                    </td>
                                </tr>
                                <div class="col-xl-4 col-lg-6">
                                    ...
                                    <div class="example-wrap">
                                        <div class="example">
                                            <!-- Modal -->
                                            <div class="modal fade modal-success" id="exampleTabs{{$rule->id}}" aria-hidden="true"
                                                ...
                                                <div class="modal-dialog modal-simple">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="" action="{{route('businessrule.update',['id' => $rule->id])}}" method="post">
                                                        {{ csrf_field() }}
                                                        {{ method_field('PUT') }}
                                                          <div class="row">
                                                            ...
                                                            @foreach($rule->category as $c)
                                                                <div class="checkbox-custom checkbox-primary col-md-3">
                                                                  <input type="checkbox" id="category" checked name="category_id[]" value="{{$c->category_id}}">
                                                                  <label class="form-control-label">{{$c->category_name}}</label>
                                                                </div>
                                                            @endforeach
                                                            ...
                                                            <div class="form-group form-material col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" name="price" value="{{$rule->price}}" required placeholder="4" />
                                                            </div>

                                                            <div class="form-group form-material col-md-4">
                                                                <label class="form-control-label">Porcentaje de Descuento:</label>
                                                                <input type="text" class="form-control discount" name="discount_percentage" required value="{{$rule->discount_percentage}}" placeholder="%" />
                                                            </div>
