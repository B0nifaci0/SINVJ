                    ...
                    <div class="nav-tabs-horizontal" data-plugin="tabs">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" role="presentation"><a class="nav-link active" data-toggle="tab"
                                    href="#exampleTabsOne" aria-controls="exampleTabsOne" role="tab">Productos Gr</a>
                            </li>
                            <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab"
                                    href="#exampleTabsTwo" aria-controls="exampleTabsTwo" role="tab">Productos Pz</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="exampleTabsOne" role="tabpanel">
                                <div class="page-content panel-body container-fluid">
                                    <table id="product_table_gr"
                                        class=" display table table-hover dataTable table-striped w-full"
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="row{{$product->id}}" class="row{{$product->id}}">
                                                ...
                                                <td>
                                                    <a class="inline-block" href="{{ $product->image }}"
                                                ...
                                                <td><span
                                                        class="text-center badge badge-secondary">{{$product->status->name}}</span>
                                                </td>
                                                @endif
                                                @if($product->status_id == 2)
                                                <td><span
                                                        class="text-center badge badge-success">{{$product->status->name}}</span>
                                                </td>
                                                @endif
                                                @if($product->status_id == 3)
                                                <td><span
                                                        class="text-center badge badge-primary">{{$product->status->name}}</span>
                                                </td>
                                                @endif
                                                ...
                                                <td>
                                                    ...
                                                    <button
                                                        ...
                                                        alt="{{$product->id}}" role="button" data-toggle="tooltip"
