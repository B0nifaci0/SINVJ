                  ...
                  <div class="example-wrap">
                    <div class="nav-tabs-horizontal" data-plugin="tabs">
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation"><a class="nav-link active" data-toggle="tab" href="#producstatusOne"
                            aria-controls="producstatusOne" role="tab">Productos Gr</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#producstatusTwo"
                            aria-controls="producstatusTwo" role="tab">Productos Pz</a></li>
                      </ul>
                    ...
                    <div class="tab-pane active" id="producstatusOne" role="tabpanel">
                      <div class="row">
                        ...
                        <div class="col-md-1 offset-md-7 col-sm-12">
                          <a class="btn btn-icon btn-danger waves-effect waves-light waves-round" data-toggle="tooltip" data-original-title="Reporte General P.GR" href="/reportEstatusG"><i class="icon fa-file-pdf-o" aria-hidden="true"></i></a>
                        </div>
                      </div>
                        ...
                        <form action="estatusproducto">
                              <div class="panel panel-bordered">
                                <div class="row">
                                  ...
                                  <div class="col-md-1 offset-md-7 col-sm-12">
                                      <a align="right" class="btn btn-icon btn-danger waves-effect waves-light waves-round" data-toggle="tooltip" data-original-title="Reporte General P.PZ" href="/reportEstatusG"><i class="icon fa-file-pdf-o" aria-hidden="true"></i></button></a>
                                   </div>
                                </div>
                                 <div class="panel-body">
                                  <div class="row">
                ...
                <div class="panel">
                  ...
                  <div class="panel-collapse collapse" id="exampleCollapseDefaultTwo" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel" style="">
                    <div class="panel-body">
                        <div class="row">
                          <div class="col-md-4 col-sm-12">
                            <h4>Reporte Por Linea Gramos y Precio</h4>
                          </div>
                          <div class="col-md-1 offset-md-7 col-sm-12">
                            <a class="btn btn-icon btn-danger waves-effect waves-light waves-round" data-toggle="tooltip" data-original-title="Reporte General" href="/gramoslineageneral"><i class="icon fa-file-pdf-o" aria-hidden="true"></i></a>
                            </div>
                        </div>
                                    ...
                                    <div class="nav-tabs-horizontal" data-plugin="tabs">
                                      ...
                                      <div class="tab-content pt-20">
                                        <div class="tab-pane active" id="exampleTabsOne" role="tabpanel">
                                          <div class="row">
                                            <div class="col-md-4 col-sm-12">
                                              <h4>Reporte Entradas Productos Status Por Gramos </h4>
                                            </div>
                                              @if(Auth::user()->type_user == 1 )
                                                <div class="col-md-1 offset-md-7 col-sm-12">
              ...
              @if(Auth::user()->type_user == 1 )
                <div class="panel">
                        <div class="panel-heading bg-warning  text-center text-white" id="exampleHeadingDefaultFour" role="tab">
                          <a class="panel-title collapsed" data-toggle="collapse" href="#exampleCollapseDefaultFour" data-parent="#exampleAccordionDefault" aria-expanded="false" aria-controls="exampleCollapseDefaultFour">Productos PZ Con Descuento</a>
                        </div>
