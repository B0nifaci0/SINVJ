    ...
    <div class="panel">
      <div class="panel-body">
        <div class="example-wrap">
          <h1 class="text-center panel-title">Clientes Sucursal</h1>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="exampleTabsOne" role="tabpanel">
                <div class="page-content panel-body container-fluid">
                  <table id="public" class=" display table table-hover dataTable table-striped w-full"
                      ...
                      <tr id="row{{ $client->id }}">
                        ...
                        <td>
                          ...
                          <button class="btn btn-icon btn-danger waves-effect waves-light waves-round delete"
                            alt="{{$client->id}}" role="button" data-toggle="tooltip" data-original-title="Eliminar">
