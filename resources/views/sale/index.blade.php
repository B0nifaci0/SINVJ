                ...
                <div class="example-wrap">
                    ...
                    <div class="panel-actions float-right">
                        <div class="container-fluid row float-right">
                            ...
                            <div class="col-6">
                                <button onclick="window.location.href='ventaspdf'" type="button" class=" btn btn-sm small btn-floating
                        ...
                        <div class="nav-tabs-horizontal" data-plugin="tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item" role="presentation"><a class="nav-link active" data-toggle="tab"
                                        href="#exampleTabsOne" aria-controls="exampleTabsOne" role="tab">Vendidos</a>
                                </li>
                                        ...
                                        <table id="sale_table_sold"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $sale->sucursal }}</td>
                                                    @endif
                                                    <td><span class="text-center badge badge-success">Vendido</span>
                                                    </td>
                                                    <td>
                                        ...
                                        <table id="sale_table_apart"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $sale->sucursal }}</td>
                                                    @endif
                                                    <td><span class="text-center badge badge-warning">Apartado</span>
                                                    </td>
                                                    <td>
                                                        <a href="/ventas/{{ $sale->id }}"><button type="button"
                                                                class="btn btn-icon btn-primary waves-effect waves-light"
