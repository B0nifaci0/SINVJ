            ...
            <h2 class="panel-title">Registar Sucursal</h2>
             <div class="row">
                ...
                <div class="form-group form-material col-md-6">
                  ...
                  <input type="text" class="form-control" name="email"  required="required" placeholder="Joyeria@gmail.com" />
                </div>
                <!-- END Input-->
                <!-- Input Para ingresar rfc-->
                <div class="form-group form-material col-md-6">
                  <label class="form-control-label">RFC*: </label>
                  <input type="text" class="form-control" name="rfc"  required="required" placeholder="FAD0027B203" />
                </div>
                <!-- END Input-->
                <!-- Input Para ingresar telefono-->
                <div class="form-group form-material col-md-6">
                  <label class="form-control-label">Telefono*: </label>
                  <input type="text" class="form-control" name="phone_number"  required="required" placeholder="5516785248" />
                </div>
                <!-- END Input-->
                <!-- Input Para ingresar direción-->
                <div class="form-group form-material col-md-6">
                  <label class="form-control-label">Dirección*: </label>
                  <input type="text" class="form-control" name="address"  required="required" placeholder="Av. juárez sur 103 etc." />
                </div>
                <!-- END Input-->
                <!-- Input Para ingresar direción-->
                <div class="form-group form-material col-md-6">
