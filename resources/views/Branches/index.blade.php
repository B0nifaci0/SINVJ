            ...
            <tr id="row{{$branch->id}}" class="row{{$branch->id}}">
              ...
              <td>
                ...
                <!-- <a href="/sucursales/{{$branch->id}}/producto"> --> <button type="button"
                  class="btn btn-icon btn-warning waves-effect waves-light waves-round products" data-toggle="tooltip"
                ...
                <button class="btn btn-icon btn-danger waves-effect waves-light waves-round delete"
                  alt="{{$branch->id}}" role="button" data-toggle="tooltip" data-original-title="Borrar">
