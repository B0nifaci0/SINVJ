                                    ...
                                    <div class="nav-tabs-horizontal" data-plugin="tabs">
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation"><a class="nav-link"
                                                    ...
                                                    aria-controls="exampleTabsThree" role="tab">General Gr</a></li>
                                            <li class="nav-item" role="presentation"><a class="nav-link"
                                                    data-toggle="tab" href="#exampleTabsFour"
                                                    aria-controls="exampleTabsFour" role="tab">General Pz</a></li>
                                        </ul>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 col-sm-6">
                                                                    ...
                                                                    <select id="" name="estatus_id" alt="1"
                                                                        ...
                                                                        <option value="2" selected='selected'>Devolucion</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-12 col-sm-6">
