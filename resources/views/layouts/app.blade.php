...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Login SINVJ | Admin Template</title>
    ...
    <link rel="stylesheet" href={{{url('assets/examples/css/pages/login-v2.css')}}}>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href={{{url('usuario')}}}>{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
