    ...
    <div class="page-register-main">
      ...
      <form method="POST" onsubmit="return submitUserForm();" action="{{ route('register') }}">
        ...
        <div class="form-group form-material floating" data-plugin="formMaterial">
          <input type="text" class="form-control empty{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name"
        ...
        <div class="form-group form-material floating" data-plugin="formMaterial">
          <input type="email" class="form-control empty{{ $errors->has('email') ? ' is-invalid' : '' }}" id="email"
        ...
        <div class="form-group form-material floating" data-plugin="formMaterial">
          <input id="password-confirm" type="password" class="form-control empty" id="inputPasswordCheck"
        ...
        <div class="form-group form-material floating" data-plugin="formMaterial">
          <input type="text" class="form-control empty{{ $errors->has('name_shop') ? ' is-invalid' : '' }}"
            id="name_shop" name="name_shop" value="{{ old('name_shop') }}" required autofocus>
